...
<asp:Panel class="order-summary-content" runat="server" ID="pnlCart">
                ...
                <td valign="top" align="left">
                    ...
                    <div class="div_bntBuynowBlack2">
                        <asp:Button runat="server" ID="btnApplyDiscountCouponCode" OnClick="btnApplyDiscountCouponCode_Click"
                            Text="<% $NopResources:ShoppingCart.ApplyDiscountCouponCodeButton %>" CssClass="btnSearchBox"
                ...
                <td valign="top" align="left">
                    ...
                    <div class="div_bntBuynowBlack2">
                        <asp:Button runat="server" ID="btnApplyGiftCardsCouponCode" OnClick="btnApplyGiftCardCouponCode_Click"
                            Text="<% $NopResources:ShoppingCart.ApplyGiftCardCouponCodeButton %>" CssClass="btnSearchBox"
                            CausesValidation="false" />
                    </div>
                    <div class="div_bntBuynowBlack3">
                    </div>
    ...
    <div class="selected-checkout-attributes" style=" text-align:left">
                ...
                <div style="float: left; width: 70px">
                    ...
                    <div class="div_bntBuynowBlack2">
                        <asp:Button ID="btnContinueShopping" OnClick="btnContinueShopping_Click" runat="server"
                            Text="<% $NopResources:ShoppingCart.ContinueShopping %>" CssClass="btnSearchBox" />
                    </div>
                    <div class="div_bntBuynowBlack3">
                    </div>
                </div>
