...
namespace NopSolutions.NopCommerce.Web.Modules
{
    public partial class ProductBox2Control : BaseNopUserControl
    {
        ...
        Nop_Product lwg_product = null;

        public override void DataBind()
        {
            base.DataBind();
            if (product == null && lwg_product != null) 
            {
                product = ProductManager.GetProductById(lwg_product.ProductId);
            }
            this.BindData();
        }
        ...
        private void BindData()
        {
            if (product != null)
            {
                ...
                hlCatalogNo.Text = catalog.CatalogNumber;
        ...
        public Nop_Product Lwg_Product 
        {
            get
            {
                return lwg_product;
