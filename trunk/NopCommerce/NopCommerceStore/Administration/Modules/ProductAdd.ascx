...
<ajaxToolkit:TabContainer runat="server" ID="ProductTabs" ActiveTabIndex="0">
    ...
    <%--//\--%>
    <ajaxToolkit:TabPanel runat="server" ID="pnlProductExtend1" HeaderText="Extra Attributes 1">
        <ContentTemplate>
            <ctl:ProductInfoAddCatalogLWG ID="ctlProductInfoAddCatalogLWG" runat="server" />    
        </ContentTemplate>
    </ajaxToolkit:TabPanel>
    <ajaxToolkit:TabPanel runat="server" ID="pnlProductExtend2" HeaderText="Extra Attributes 2">
        <ContentTemplate>
