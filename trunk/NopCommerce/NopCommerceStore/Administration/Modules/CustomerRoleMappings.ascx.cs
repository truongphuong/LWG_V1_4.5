...
namespace NopSolutions.NopCommerce.Web.Administration.Modules
{
    public partial class CustomerRoleMappingsControl : BaseNopAdministrationUserControl
    {
        private void BindData()
        {
            ...
            CustomerRoleMappingControl.DealerID = customer.DealerId;
        ...
        public void SaveInfo(int cusId)
        {
            ...
            if (customer != null)
            {
                ...
                foreach (int customerRoleId in CustomerRoleMappingControl.SelectedCustomerRoleIds)
                {
                    ...
                    if (customerRoleId == 5) // dealer
                    {
                        CustomerManager.UpdateCustomerDealer(customer.CustomerId, CustomerRoleMappingControl.DealerID);
                    }
                }
            }
        }
