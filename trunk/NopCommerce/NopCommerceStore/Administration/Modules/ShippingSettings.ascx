...
<table width="100%" class="adminContent">
    ...
    <tr>
        <td class="adminTitle">
            <nopCommerce:ToolTipLabel runat="server" ID="OnlyDomesticToolTipLabel" Text="<% $NopResources:Admin.ShippingSettings.OnlyDomesticShipping%>"
                ToolTip="<% $NopResources:Admin.ShippingSettings.OnlyDomesticShipping.Tooltip %>"
                ToolTipImage="~/Administration/Common/ico-help.gif" />
        </td>
        <td class="adminData">
            <asp:CheckBox runat="server" ID="chkOnlyDomestic" Checked="false"></asp:CheckBox>
        </td>
    </tr>
