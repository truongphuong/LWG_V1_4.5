...
namespace NopSolutions.NopCommerce.Web.Administration.Modules
{
    public partial class ShippingSettingsControl : BaseNopAdministrationUserControl
    {
        ...
        private void BindData()
        {
            ...
            chkOnlyDomestic.Checked = SettingManager.GetSettingValueBoolean("Shipping.OnlyDomesticShipping");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    SettingManager.SetParam("Shipping.OnlyDomesticShipping", chkOnlyDomestic.Checked.ToString());
