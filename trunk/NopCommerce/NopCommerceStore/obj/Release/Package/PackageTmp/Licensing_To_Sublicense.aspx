<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true"
    CodeBehind="Licensing_To_Sublicense.aspx.cs" Inherits="NopSolutions.NopCommerce.Web.Licensing_To_Sublicense" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" runat="server">
    <div class="html-header">
        Home / Licensing / <span style="color: #0068a2;">To Sublicense</span>
    </div>
    <div class="clear-15">
    </div>
    <div>
            ...
            <div style="width: 660px; float: left; padding-left: 40px;">
                ...
                <div>
                    <div style="width: 497px; margin-left: 81px; margin-right: 82px; margin-top: 30px;">
                        <uc1:Form runat="server" ID="licenseForm" Type="Sublicense"></uc1:Form>
                    </div>
                </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        var temp1 = document.getElementById("L4");
