<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="XmlPayment.ascx.cs" Inherits="NopSolutions.NopCommerce.Web.Templates.Payment.SecurePay.XmlPayment" %>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlCreditCardType" runat="server" CssClass="dropDownLists">
                ...
                <asp:ListItem Value="MASTER CARD">MASTERCARD</asp:ListItem>
                <asp:ListItem Value="BANK CARD">BANKCARD</asp:ListItem>
