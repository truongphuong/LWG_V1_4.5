<%@ Page Language="C#" MasterPageFile="~/MasterPages/TwoColumn.master" AutoEventWireup="true"
    CodeBehind="Dealer_List.aspx.cs" Inherits="NopSolutions.NopCommerce.Web.Dealer_List" %>

<%@ Register Src="Modules/Dealers_Promotions.ascx" TagName="Dealers_Promotions" TagPrefix="uc1" %>
<%@ Register src="Modules/DealerList.ascx" tagname="DealerList" tagprefix="uc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" runat="server">
    <div style="text-align: left;">
        ...
        <div style="width: 720px; float: left; margin-left: 10px; background-color: #FFFFFF;">
            ...
            <div style=" background-color: #ffffff; padding-left: 35px; padding-right: 15px;
                color: #000000">
                <div class="html-header">
                    Home / Dealers/Promotions / <span style="color: #0068a2;">Dealer List</span>
                </div>
                
                <div>
                    <uc2:DealerList ID="DealerList1" runat="server" />
                </div>
            </div>
            <div style="height: 7px;">
                <div class="ftb_bot1">
