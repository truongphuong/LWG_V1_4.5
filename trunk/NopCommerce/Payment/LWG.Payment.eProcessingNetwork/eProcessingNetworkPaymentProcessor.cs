...
using LWG.Payment.eProcessingNetwork.net.authorize.api;

namespace NopSolutions.NopCommerce.Payment.Methods.eProcessingNetwork
{
    /// <summary>
    /// Authorize.Net payment processor
    /// </summary>
    public class eProcessingNetworkPaymentProcessor : IPaymentMethod
    {
        #region Fields
        ...
        /// </summary>
        public eProcessingNetworkPaymentProcessor()
        {
        ...
        /// <summary>
        /// Initializes the eProcessingNetwork payment processor
        /// </summary>
        private void InitSettings()
        {
            useSandBox = SettingManager.GetSettingValueBoolean("PaymentMethod.eProcessingNetwork.UseSandbox");
            transactionKey = SettingManager.GetSettingValue("PaymentMethod.eProcessingNetwork.TransactionKey");
            loginID = SettingManager.GetSettingValue("PaymentMethod.eProcessingNetwork.LoginID");

            if (string.IsNullOrEmpty(transactionKey))
                throw new NopException("eProcessingNetwork API transaction key is not set");

            if (string.IsNullOrEmpty(loginID))
                throw new NopException("eProcessingNetwork API login ID is not set");

            webService = new LWG.Payment.eProcessingNetwork.net.authorize.api.Service();
            if (useSandBox)
            {
        ...
        /// <summary>
        /// Gets eProcessingNetwork URL
        /// </summary>
        /// <returns></returns>
        private string GeteProcessingNetworkUrl()
        {
            return "https://www.eProcessingNetwork.Com/cgi-bin/an/order.pl"; // eProcessingNetwork url
                //useSandBox ? "https://test.authorize.net/gateway/transact.dll" :  authorizeNet url
        ...
        public void ProcessPayment(PaymentInfo paymentInfo, Customer customer, Guid orderGuid, ref ProcessPaymentResult processPaymentResult)
        {
            ...
            string reply = null;
            Byte[] responseData = webClient.UploadValues(GeteProcessingNetworkUrl(), form);
            ...
            {
                processPaymentResult.Error = "eProcessingNetwork unknown error";
                processPaymentResult.FullError = "eProcessingNetwork unknown error";
            }
        }
        ...
        {
            return SettingManager.GetSettingValueDecimalNative("PaymentMethod.eProcessingNetwork.AdditionalFee");
        }
        ...
        public void ProcessRecurringPayment(PaymentInfo paymentInfo, Customer customer, Guid orderGuid, ref ProcessPaymentResult processPaymentResult)
        {
            ...
            if (!paymentInfo.IsRecurringPayment)
            {
                ...
                LWG.Payment.eProcessingNetwork.net.authorize.api.CreditCardType creditCard = new LWG.Payment.eProcessingNetwork.net.authorize.api.CreditCardType();
