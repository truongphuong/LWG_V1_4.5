...
namespace NopSolutions.NopCommerce.Payment.Methods.PurchaseOrder
{
    /// <summary>
    /// Purchase order payment processor
    /// </summary>
    public class PurchaseOrderPaymentProcessor : IPaymentMethod
    {
        #region Methods
