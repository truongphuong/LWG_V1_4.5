<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true"
    CodeBehind="Licensing_To_Record.aspx.cs" Inherits="NopSolutions.NopCommerce.Web.Licensing_To_Record" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" runat="server">
    <div class="html-header">
        Home / Licensing / <span style="color: #0068a2;">To Record</span>
    </div>
    <div class="clear-15">
    </div>
    <div>
        ...
        <div style="width: 700px; float: left; margin-left: 10px; background-color: #FFFFFF;">
            <div style="width: 660px; float: left; padding-left: 40px;">
                <div class="html-title">
                    License to Record (Audio/Video)
                </div>
                <div style="margin-top: 20px">
                    In May, 2011 LudwigMasters Publications, LLC entered into an agreement with CopyCat
                    Music Licensing to administer the licensing rights to our catalog of music.
                    <br />
                    <br />
                    Please contact <a href="mailto:Dustin@CopyCatLicensing.com?subject=License Request%3ALudwigMasters Publications">
                        Dustin Oldenburg</a>, Licensing Administrator, with Copycat Music Licensing,
                    LLC for all licensing requests.
                </div>
                ...
                <div>
                    <div style="width: 497px; margin-left: 81px; margin-right: 82px; margin-top: 30px;">
                        <uc1:Form runat="server" ID="licenseForm" Type="Record"></uc1:Form>
                    </div>
                </div>--%>
    ...
    <script type="text/javascript" language="javascript">
        ...
        var temp1 = document.getElementById("L1");
