<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductRequireReprintSourceLWG.ascx.cs"
    Inherits="NopSolutions.NopCommerce.Web.Administration.Modules.ProductRequireReprintSourceLWGControl" %>
<center>
    <div>
        <asp:UpdatePanel ID="updatepnReprintSource" runat="server">
            <ContentTemplate>
                <asp:Panel ID="pnListReprintSource" runat="server">
                    ...
                    <table cellpadding="0" cellspacing="0" style="line-height: 25px; font-family: Tahoma;
                        font-size: 12px;">
                        <asp:Repeater ID="rptReprintSource" runat="server" OnItemCommand="rptReprintSource_ItemCommand">
                            <HeaderTemplate>
                                <tr>
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td align="center" valign="top">
                                        <asp:Literal ID="ltrID" runat="server" Text='<%# Eval("ReprintSourceId") %>'></asp:Literal>
                                    </td>
                                    <td align="left" valign="top">
                                        <asp:Literal ID="ltrName" runat="server" Text='<%#  Eval("Name") %>'></asp:Literal>
                                    </td>
                                    <td align="center" valign="top" width="50px">
                                        <asp:LinkButton ID="lnkbtnEdit" runat="server" Text="Edit" CommandName="EDIT" CommandArgument='<%# Eval("ReprintSourceId") %>'></asp:LinkButton>
                                    </td>
                                    <td align="center" valign="top" width="50px">
                                        <asp:LinkButton ID="lnkbtnDelete" runat="server" Text="Delete" OnClientClick="return confirm('Are you sure you wish to delete this record?');"
                                            CommandName="DELETE" CommandArgument='<%# Eval("ReprintSourceId") %>'></asp:LinkButton>
                                    </td>
                                </tr>
                                <tr>
                ...
                <asp:Panel ID="pnEditReprintSource" runat="server" DefaultButton="btnAdd" Visible="false">
                    <div style="width: 880px; float: left; padding: 20px; text-align: left; font-family: Times New Roman;
                        font-size: 18pt; color: #127ed7; font-weight: bold;">
