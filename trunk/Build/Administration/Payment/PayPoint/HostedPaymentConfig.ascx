<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HostedPaymentConfig.ascx.cs"
    Inherits="NopSolutions.NopCommerce.Web.Administration.Payment.PayPoint.HostedPaymentConfig" %>
...
<table class="adminContent">
    ...
    <tr>
        ...
        <td class="adminData">
            <asp:TextBox runat="server" ID="txtRemotePassword" CssClass="adminInput" />
        </td>
    </tr>
    <tr>
        <td class="adminTitle">
        ...
        <td class="adminData">
            <asp:TextBox runat="server" ID="txtDigestKey" CssClass="adminInput" />
        </td>
    </tr>
    <tr>
        <td class="adminTitle">
